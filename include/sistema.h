...
class Sistema {
  ...
  public:
		...
		*/
		...
		/*! Verifica se um usuario está conectado
				@param id o id do usuario a ser verificado
				@return true se o usuario estiver conectado, e false do contrário
		*/
		bool verifyLoginStatus(int id);
};
